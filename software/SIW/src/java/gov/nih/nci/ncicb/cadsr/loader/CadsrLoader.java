...
public class CadsrLoader {
  ...
  private static Logger logger = Logger.getLogger(CadsrLoader.class.getName());
  ...
  public void run(String fileDir, String projectName, Float projectVersion) throws Exception {
